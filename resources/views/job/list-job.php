...
if ($total_jobs <= $page_max) $page_max = $total_jobs;
...
$prev_page_max = 0;
$total_jobs = count($jobs);
$page_max = $prev_page_max + $page_offset;
if ($total_jobs <= $page_max) $page_max = $total_jobs;
$show_statement = "Show " . $prev_page_max + 1 . "-$page_max of $total_jobs";
$prev_page_max = $page_max;
    ...
    <div class="show-and-sort">
        ...
        <div class="time-toggle">
            <button id="sort-toggle" class="sort-time-toggle">
                <svg id="sort-icon" xmlns="http://www.w3.org/2000/svg" width="15" height="15"><path fill="currentColor" d="M7.5 12L0 4h15z"/></svg>
